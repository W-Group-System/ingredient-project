...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_crms' => [
        'driver' => 'mysql',
        'host' => env('DB_HOST_CRMS', '127.0.0.1'),
        'port' => env('DB_PORT_CRMS', '3306'),
        'database' => env('DB_DATABASE_CRMS', 'forge'),
        'username' => env('DB_USERNAME_CRMS', 'forge'),
        'password' => env('DB_PASSWORD_CRMS', ''),
        'unix_socket' => env('DB_SOCKET', ''),
        'charset' => 'utf8mb4',
        'collation' => 'utf8mb4_unicode_ci',
        'prefix' => '',
